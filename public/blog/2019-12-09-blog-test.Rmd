...
<center>![](/blog/2019-12-09-blog-test_files/sepal_length_petal_length.JPG){width=70% height=70%}</center>

```{R,eval = FALSE}
sns.regplot(data=iris,x='sepal length (cm)',y='sepal width (cm)')
```

<center>![](/blog/2019-12-09-blog-test_files/sepal_length_sepal_width.JPG){width=70% height=70%}</center>

```{R,eval = FALSE}
sns.regplot(data=iris,x='petal length (cm)',y='petal width (cm)')
```

<center>![](/blog/2019-12-09-blog-test_files/petal_length_petal_width.JPG){width=70% height=70%}</center>
...
<center> ![](/blog/2019-12-09-blog-test_files/petal_length_sepal_width.JPG){width=70% height=70%} </center>

All in all, Python

![](/blog/2019-12-09-blog-test_files/image.png)